...
//            }
 ...
 $('#addmore').click(function(){
  ...
  var html = "<tr class='tr_input' id='row"+index+"'><td></td><td><input type='text' class='username' id='username_"+index+"' placeholder='Enter product'></td><td><input type='text' class='salary' name='salary[]' id='salary_"+index+"' ></td><td><button type='button' name='remove' data-row='row"+index+"' class='btn btn-danger btn-xs remove'>-</button></td></tr>";
...
$('#save').click(function(){
  ...
  var item_total = [];
  $('.room').each(function(){
   item_room.push($(this).text());
  });
  $('.username').each(function(){
   item_prod.push($(this).text());
  });
  ...
  $.ajax({
   ...
   method:"POST",
   data:{item_room:item_room, item_prod:item_prod, item_price:item_price, item_total:item_total},
   success:function(data){
    alert(data);
