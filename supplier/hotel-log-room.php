                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Hotel Room Log</li>
                            </ol>
                        </div>
                    </div>
					<div class="row">
                            ...
                            <div class="card card-box">
                                ...
                                <div class="row">
									<div class="profile-tab-box">
										<div class="p-l-20">
											<ul class="nav ">
												<li class="nav-item tab-all"><a class="nav-link active show" href="#tab1" data-toggle="tab">Slider</a></li>
